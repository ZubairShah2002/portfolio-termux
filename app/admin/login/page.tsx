    ...
    <div style={{ minHeight: '100vh', background: '#07080a', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, fontFamily: "'Space Grotesk', system-ui, sans-serif" }}>
      ...
      <div style={{ position: 'relative', zIndex: 10, width: '100%', maxWidth: 400 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <h1 style={{ color: 'white', fontSize: 24, fontWeight: 900, letterSpacing: '-0.03em', marginBottom: 5 }}>
            <span style={{ color: '#6ee7b7' }}>ZS</span> Admin Panel
          </h1>
          <p style={{ color: 'rgba(255,255,255,0.3)', fontSize: 13 }}>Zubair Shah — Portfolio CMS</p>
        </div>
          ...
          <form onSubmit={submit}>
            {[['email','email','admin@portfolio.dev'],['password','password','••••••••']] .map(([k, t, pl]) => (
              <div key={k} style={{ marginBottom: 16 }}>
                ...
                <input
                  type={t}
                  value={form[k as 'email' | 'password']}
                  placeholder={pl}
            ...
            {error && (
              <div style={{ background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.2)', borderRadius: 9, padding: '9px 13px', marginBottom: 16, color: '#f87171', fontSize: 13 }}>
                {error}
              </div>
            )}
