...
export const mockProfile: Profile = {
  ...
  tagline: 'I engineer systems that scale, experiences that impress, and code that lasts.',
  bio: '8+ years building the infrastructure and interfaces behind products used by millions. Previously at Vercel, Stripe & Figma — now helping startups move at orbital velocity.',
  bioExtra: "When I'm not deep in distributed systems, I'm auditing tech stacks globally, contributing to OSS, and mentoring the next wave of engineers.",
